<header id="header"
    class="module header w-full top-0 left-0 fixed z-200 down_lg:overflow-hidden bg-white h-50 border-b-1 border-solid border-black">
        ...
        <nav class="row navbar items-center h-[113px] text-xl xl:justify-between down_xl:justify-around ">
            <div class="col w-2/3 down_lg:flex down_xl:w-[70%] flex-shrink header-mobile relative items-center">
                <div class="lg:w-full flex flex-row items-center relative">
                    ...
                    <div class="col w-full navbar-collapse main-menu flex down_lg:absolute down_lg:top-[84px] down_lg:left-[-30px]"
